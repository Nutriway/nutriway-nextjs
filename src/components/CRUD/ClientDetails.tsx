                ...
                <div className="grid gap-4 px-4 mb-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
                    <div className="sm:col-span-2">
                        ...
                        <div className="flex items-center space-x-4">
                            <Image
                                className="mb-4 w-16 h-16 rounded-full sm:w-20 sm:h-20"
                            ...
                            />
                            <div>
                                <h2 className="flex items-center mb-2 text-xl font-bold leading-none text-gray-900 sm:text-2xl light:text-white">
                                    {info.attributes.client.data.attributes.username}
                                </h2>
                            </div>
                        </div>
                        <dl>
                            <dt className="mb-2 font-semibold leading-none text-gray-900 light:text-white">
                                Objetivo da consulta
                            </dt>
                            <dd className="flex items-center mb-4 text-gray-900 sm:mb-5 light:text-white">
                                <svg
                                    className="w-4 h-4 mr-1.5 text-primary-800 light:text-primary-800"
                                    aria-hidden="true"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                ...
                                <span className="font-light text-gray-500 light:text-gray-400">
                                    {info.attributes.goal}
                                </span>
                            </dd>
                            <dt className="mb-2 font-semibold leading-none text-gray-900 light:text-white">
                                Condições médicas
                            ...
                            <dd className="flex items-center text-gray-900 light:text-white">
                                ...
                                <span className="font-light text-gray-500 light:text-gray-400">
                                    {info.attributes.medical_condition}
                                </span>
                            </dd>
                        </dl>
                    </div>
                    <dl>
                        ...
                        <dd className="mb-4 font-light text-gray-500 sm:mb-5 light:text-gray-400">
                            {info.attributes.client.data.attributes.age}
                        </dd>
                        <dt className="mb-2 font-semibold leading-none text-gray-900 light:text-white">Género</dt>
                        <dd className="mb-4 font-light text-gray-500 sm:mb-5 light:text-gray-400">
                            {info.attributes.client.data.attributes.gender}
                        </dd>
                        <dt className="mb-2 font-semibold leading-none text-gray-900 light:text-white">
                            Altura / Peso
                        </dt>
                        <dd className="mb-4 font-light text-gray-500 sm:mb-5 light:text-gray-400">
                            {info.attributes.client.data.attributes.height}cm /{' '}
                            {info.attributes.client.data.attributes.weight}kg
                        </dd>
                        <dt className="mb-2 font-semibold leading-none text-gray-900 light:text-white">
                            Atividade Física
                        </dt>
                        <dd className="font-light text-gray-500 light:text-gray-400">
                            {mapActivity(info.attributes.client.data.attributes.activity)}
                        </dd>
                    </dl>
                </div>
            </div>
