            ...
            <nav className="z-10 w-full absolute">
                <Container>
                    <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
                            ...
                            <div className="relative flex items-center lg:hidden max-h-10">
                                ...
                                >
                                    <div
                                        aria-hidden="true"
                                        id="line"
                                        className="m-auto h-0.5 w-5 rounded bg-sky-900 light:bg-gray-300 transition duration-300"
                                    ></div>
                                    <div
                                        aria-hidden="true"
                                        id="line2"
                                        className="m-auto mt-2 h-0.5 w-5 rounded bg-sky-900 light:bg-gray-300 transition duration-300"
                                    ></div>
                                </label>
                            </div>
                        </div>
                        <div
                            aria-hidden="true"
                            className="fixed z-10 inset-0 h-screen w-screen bg-white/70 backdrop-blur-2xl origin-bottom scale-y-0 transition duration-500 peer-checked:origin-top peer-checked:scale-y-100 lg:hidden light:bg-gray-900/70"
                        ></div>
                        <div
