        ...
        <div id="blog">
            <Container>
                <div className="mb-12 space-y-2 text-center">
                    ...
                    <p className="lg:mx-auto lg:w-6/12 text-gray-600 light:text-gray-300">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div
                        className="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 light:shadow-none light:border-gray-700 light:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                        ...
                        <div className="mt-6 relative">
                            <h3 className="text-2xl font-semibold text-gray-800 light:text-white">
                                De fuga fugiat lorem ispum laboriosam expedita.
                            </h3>
                            <p className="mt-6 mb-8 text-gray-600 light:text-gray-300">
