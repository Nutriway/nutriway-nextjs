            ...
            <Container>
                <div className="md:w-2/3 lg:w-3/4">
                    ...
                    <p className="text-gray-600 light:text-gray-300">
                        Oferecemos consultas personalizadas, acompanhamento nutricional e planos alimentares
                        individualizados, tudo no conforto da sua casa. Os nossos nutricionistas são especializados em
                        diferentes áreas da nutrição, garantindo que receberá o melhor atendimento possível.
                    </p>
                </div>
                    ...
                    <div className="group relative bg-white light:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                        <div className="relative space-y-8 py-12 p-8">
                            ...
                            <div className="space-y-2">
                                <h5 className="text-xl font-semibold text-gray-700 light:text-white transition group-hover:text-secondary">
                                    Consultas online
                                </h5>
