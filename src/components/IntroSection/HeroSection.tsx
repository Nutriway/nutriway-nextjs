                    ...
                    <div className="lg:w-2/3 text-center mx-auto">
                        ...
                        <div className="hidden py-8 mt-16 border-y border-gray-100 light:border-gray-800 sm:flex justify-between">
                            <div className="text-left">
                                <h6 className="text-lg mr-2 font-semibold text-gray-700 light:text-white">Nutricionistas certificados</h6>
                                <p className="mt-2 mr-4 text-gray-500">Marca a sua consulta no dia e hora que seja mais conveniente.</p>
                            </div>
                            <div className="text-left">
                                <h6 className="text-lg mr-2 font-semibold text-gray-700 light:text-white">Planos personalizados</h6>
                                <p className="mt-2 mr-4 text-gray-500">Recebe o seu plano nutriconal prescrito por um nutricionista certificado.</p>
                            </div>
                            <div className="text-left">
