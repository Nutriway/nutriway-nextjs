...
export default function SimpleCTA({ title, description, buttonText }: SimpleCTAProps) {
    return (
        <section className="bg-white lightbg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 rounded-2xl bg-gray-50">
                <div className="mx-auto max-w-screen-md text-center">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-gray-900 lighttext-white">{title}</h2>
