...
export default function AppFooter() {
    return (
        <footer className="pb-20 md:pb-10 w-full">
                    ...
                    <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
                        ...
                        >
                            <ul className="list-inside list-disc space-y-8">
                                <li><a href="#" className="transition hover:text-primary-900-900">Página Inicial</a>
                                </li>
                                <li><a href="#" className="transition hover:text-primary-900-900">Entre em contacto</a>
                                </li>
                            </ul>
            ...
            >Junte-se a nós e descubra como a nutrição adequada pode transformar sua vida</span
            >

                            <span className="block text-gray-500 light:text-gray-400">Nutriway &copy; <span
                                id="year"></span></span>

                            <span className="flex justify-between text-gray-600 light:text-white">
              <a href="#" className="font-medium"> Politica de Privacidade</a>
            </span>

                            <span className="block text-gray-500 light:text-gray-400"
                            >Preicsa de ajuda? <a href="#"
                                                  className="font-semibold text-gray-600 light:text-white"> Contacte-nos</a></span
                            >
                        </div>
                    </div>
                </div>
