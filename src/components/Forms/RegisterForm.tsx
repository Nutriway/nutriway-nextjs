        ...
        >
            <div className="grid gap-6 sm:grid-cols-2">
                <Form.Field name="email">
                    <Form.Label className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Email</Form.Label>
                    <Form.Control
                        asChild
                        onChange={(e) => {
                    ...
                    >
                        <input type="email" name="email" id="email" value={formState.email} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="name@email.com" required />
                    </Form.Control>
                    <Form.Message className="text-[13px] text-red-600 opacity-[0.8] absolute" match="typeMismatch">
                        Por favor insire um email válido
                    </Form.Message>
                </Form.Field>
                <Form.Field name="full-name">
                    <Form.Label className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Nome completo</Form.Label>
                    <Form.Control
                        asChild
                        onChange={(e) => {
                    ...
                    >
                        <input type="text" name="full-name" id="full-name" value={formState.name} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="João Silva" required />
                    </Form.Control>
                    <Form.Message className="text-[13px] text-red-600 opacity-[0.8] absolute" match="valueMissing">
                        Por favor indique o seu nome completo
                    </Form.Message>
                </Form.Field>
                <Form.Field name="password">
                    <Form.Label className="block mb-2 text-sm font-medium text-gray-900 light:text-white">Palavra-passe</Form.Label>
                    <Form.Control
                        asChild
                        onChange={(e) => {
                ...
                <Form.Field name="confirm-password">
                    ...
                    <Form.Message className="text-[13px] text-red-600 opacity-[0.8] absolute" match={(value, formData) => value !== formData.get('password')}>
                        As palavras-passe não coincidem
                    </Form.Message>
                </Form.Field>
            </div>
            <div className="flex items-center">
                <div className="w-full h-0.5 bg-gray-200 light:bg-gray-700"></div>
                <div className="px-5 text-center text-gray-500 light:text-gray-400">ou</div>
                <div className="w-full h-0.5 bg-gray-200 light:bg-gray-700"></div>
            </div>
            <div className="space-y-3">
                <a href="#" className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 light:focus:ring-gray-700 light:bg-gray-800 light:text-gray-400 light:border-gray-600 light:hover:text-white light:hover:bg-gray-700">
                ...
                <a href="#" className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 light:focus:ring-gray-700 light:bg-gray-800 light:text-gray-400 light:border-gray-600 light:hover:text-white light:hover:bg-gray-700">
                    <svg className="w-5 h-5 mr-2 text-gray-900 light:text-white" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Form.Field name="terms">
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                            <Form.Label className="font-light text-gray-500 light:text-gray-300">
                                Ao registar-se, está a criar uma conta Nutriway e concorda com os{' '}
                                <a className="font-medium text-primary-600 light:text-primary-500 hover:underline" href="#">
                                    Termos de uso
                                </a>{' '}
                                e a{' '}
                                <a className="font-medium text-primary-600 light:text-primary-500 hover:underline" href="#">
                    ...
                    <div className="flex items-start">
                        <div className="flex items-center h-5">
                            <Form.Control asChild>
                                <input id="newsletter" aria-describedby="newsletter" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 light:bg-gray-700 light:border-gray-600 light:focus:ring-primary-600 light:ring-offset-gray-800" />
                            </Form.Control>
                        </div>
                        <div className="ml-3 text-sm">
                            <Form.Label className="font-light text-gray-500 light:text-gray-300">Envie emails da newsletter.</Form.Label>
                        </div>
                    </div>
                </Form.Field>
            </div>
            <button type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center light:bg-primary-600 light:hover:bg-primary-700 light:focus:ring-primary-800">
                Crie a sua conta
            </button>
        </Form.Root>
    );
