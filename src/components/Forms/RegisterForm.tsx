...
async function doRegister(
    ...
    const { jwt } = await clientFetcher<{ jwt: string }>({
        url,
        method: 'post',
        ...
        >
            <div className="grid gap-6 sm:grid-cols-2">
                <Form.Field name="email">
                    <Form.Label className="block mb-2 text-sm font-medium text-gray-900 light:text-white">
                        Email
                    </Form.Label>
                    <Form.Control
                        asChild
                ...
                <Form.Field name="confirm-password">
                    ...
                    <Form.Message
                        className="text-[13px] text-red-600 opacity-[0.8] absolute"
            ...
            <div className="space-y-3">
                ...
                >
                    <svg
                        className="w-5 h-5 mr-2 text-gray-900 light:text-white"
                        viewBox="0 0 21 20"
                        fill="none"
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                            <Form.Label className="font-light text-gray-500 light:text-gray-300">
                                ...
                                <a
                                    className="font-medium text-primary-600 light:text-primary-500 hover:underline"
                                    href="#"
                                >
                                    Termos de uso
                                </a>{' '}
