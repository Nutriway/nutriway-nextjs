            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
                <div className="w-full place-self-center lg:col-span-6">
                    <div className="p-6 mx-auto bg-white rounded-lg shadow light:bg-gray-800 sm:max-w-xl sm:p-8">
                        <a href="#"
                           className="inline-flex items-center mb-4 text-xl font-semibold text-gray-900 light:text-white">
                            <Image className="w-8 h-8 mr-2" width={32} height={32}
                        ...
                        <p className="text-sm font-light text-gray-500 light:text-gray-300">
                            Inicie sessão. Não tem uma conta? <a href="#"
                                                                 className="font-medium text-primary-600 hover:underline light:text-primary-500">Registe-se</a>.
                        </p>
                        <form className="mt-4 space-y-6 sm:mt-6" action="#">
                            ...
                            <div className="space-y-3">
                                ...
                                <a href="#"
                                   className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 light:focus:ring-gray-700 light:bg-gray-800 light:text-gray-400 light:border-gray-600 light:hover:text-white light:hover:bg-gray-700">
                                    <svg className="w-5 h-5 mr-2 text-gray-900 light:text-white" viewBox="0 0 21 20"
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="remember"
                                               className="text-gray-500 light:text-gray-300">Lembrar-me</label>
                                    </div>
                                </div>
                                <a href="#"
                                   className="text-sm font-medium text-primary-600 hover:underline light:text-primary-500">Esqueceu
                                    da palavra-passe?</a>
                            </div>
                            <button type="submit"
                ...
                <div className="mr-auto place-self-center lg:col-span-6">
                    <Image className="hidden mx-auto lg:flex" width={1000} height={1000}
