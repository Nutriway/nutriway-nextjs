    ...
    return (
        <section className="">
            <div className="flex justify-between">
                ...
                <button className="flex items-center justify-center rounded-l-md py-2 pl-3 pr-4 text-gray-400 hover:text-gray-500 focus:relative md:w-9 md:px-2 md:hover:bg-gray-50">
                    Editar
                </button>
            </div>
